...
class TestAnnotAndMaskUtils:
    ...
    def test_scale_slide_annotations(self):
        ...
        for sf in (0.5, 1.0):
            modified = scale_slide_annotations(copy.deepcopy(cfg.annotations),
                                               sf=sf)
            assert modified[0]["annotation"]["elements"][0]["center"] == [
                int(sf * j) for j in cfg.annotations[0]["annotation"]
                ["elements"][0]["center"]
            ]
    ...
    def test_get_scale_factor_and_appendStr(self):
        ...
        in_out = [
            ...
            [(None, 10.0), (0.25, "&magnification=10.00000000")],
            [(None, None), (1.0, "")],
        ]
