...
def test_prep(girderClient):  # noqa
    ...
    cfg.iteminfo = cfg.gc.get("/item",
                              parameters={"text":
                                          "TCGA-A2-A0YE-01Z-00-DX1"})[0]
