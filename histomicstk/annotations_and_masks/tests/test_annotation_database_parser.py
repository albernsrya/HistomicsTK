...
class TestDatabaseParser:
    ...
    def test_dump_annotations_locally_1(self):
        ...
        result = pd.read_sql_query("""SELECT count(*) FROM 'folders';""",
                                   dbcon)
        assert int(result.loc[0, :]) == 2

        result = pd.read_sql_query("""SELECT count(*) FROM 'items';""", dbcon)
    ...
    def test_dump_annotations_locally_2(self):
        ...
        result = pd.read_sql_query("""SELECT * FROM 'annotation_docs';""",
                                   dbcon)
        ...
        result = pd.read_sql_query("""SELECT * FROM 'annotation_elements';""",
                                   dbcon)
